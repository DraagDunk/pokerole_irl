# Generated by Django 3.2.19 on 2023-05-29 17:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.PositiveIntegerField(choices=[(0, 'Starter'), (1, 'Beginner'), (
                    2, 'Amateur'), (3, 'Ace'), (4, 'Pro'), (5, 'Master'), (6, 'Champion')], default=0)),
                ('held_item', models.ForeignKey(blank=True, null=True,
                 on_delete=django.db.models.deletion.SET_NULL, to='pokerole_app.item')),
                ('moves', models.ManyToManyField(
                    to='pokerole_app.Move', blank=True)),
                ('species', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='pokerole_app.pokemonspecies')),
                ('trainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                 related_name='owned_pokemon', to='worlds_app.character')),
            ],
        ),
    ]
